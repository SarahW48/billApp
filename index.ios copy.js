...
/*  deleteAll();
    ...
    var billOwnerEmail = 'User1@oracle.com';
    var billOwner = realm.objects('User').filtered(`email="${billOwnerEmail}"`);
    if (billOwner === null || billOwner.length === 0) {
      return;
    } */
    initAdmin();
    return (
      //<SummaryPage data={{user: billOwner[0]}}/>
      //<TabPage data={{user: billOwner[0]}}/>
      //<AddBillPage data={{user : billOwner[0]}}/>
    /*  <EditBillOwedUser data={{billOwedUser: {
      owedBy: 'User1@oracle.com',
      billTo: '1461538527832+Test',
      amount: 10,
      paid: true}}}/> */
      //<Text>Test</Text>
      <Navigator
